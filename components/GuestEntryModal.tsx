...
export default function GuestEntryModal() {
    ...
    const handleRegister = (e: React.FormEvent) => {
        ...
        // Note: operationalData must be imported if used here. 
        // If it's not defined, this will cause a ReferenceError.
        // Assuming operationalData is global or needs import.
        if (typeof operationalData !== 'undefined') {
    ...
    const goBack = () => {
        setStep(1);
        // Assuming logout exists on useGuestAuth
        const { logout } = useGuestAuth() as any;
        if (logout) logout();
    };
